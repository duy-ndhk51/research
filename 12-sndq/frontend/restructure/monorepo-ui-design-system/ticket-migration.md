...
- Move `sndq-ui-v2` to `apps/ui-v2-dev/`
...
- Components stay in `apps/ui-v2-dev/` until standardized — package only holds production-ready code
- Both `apps/docs/` and `apps/ui-v2-dev/` import `@sndq/ui-v2` directly
